...
public class CreateFileMessageProcessorDebuggable
    extends CreateFileMessageProcessor
    implements DebugInfoProvider
{


    public CreateFileMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("mapDataFromExpression", "Map data from expression", (com.ach.achViewer.ach.ACHFile.class), mapDataFromExpression, muleEvent));
